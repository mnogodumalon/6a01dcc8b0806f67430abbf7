...
const PROXY_BASE = '';
const APP_ID = '6a01dcbb56f74cf076ebf8a0';
...
export default function PublicFormTedtErfassung() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Tedt Erfassung — Formular</h1>
        </div>
